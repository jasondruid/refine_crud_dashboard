...
const Profile = ({ type, name, avatar, email, properties }: ProfileProps) => {
  ...
  return (
    <Box>
      <Typography fontSize={25} fontWeight={700}   color={actualTheme === "dark" ? "#f7f7f7" : "#11142D"}>
        {type} Profile
      </Typography>

      <Box mt="20px" borderRadius="15px" padding="20px" bgcolor={actualTheme === "dark" ? "#7C7C7D" : "#FCFCFC"}>
        <Box
          sx={{
            display: "flex",
      ...
      {properties.length > 0 && (
        <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor={actualTheme === "dark" ? "#7C7C7D" : "#FCFCFC"}>
