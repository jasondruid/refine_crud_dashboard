            ...
            <ListItemButton
              ...
              sx={{
                ...
                "&.Mui-selected": {
                  ...
                  backgroundColor: isSelected ? "#475be8" : "red",
                },
                justifyContent: "center",
                margin: "10px auto",
                borderRadius: "12px",
                minHeight: "56px",
                width: "90%",
                backgroundColor: theme === "dark" ? "#9872b0" : "inherit",
              }}
            >
              <ListItemIcon
                sx={{
      ...
      >
        <ListItemButton
          ...
          sx={{
            ...
            minHeight: "56px",
            width: "90%",
            bgcolor: theme === "dark" ? "#9872b0" : "inherit",
    ...
    >
      <ListItemButton
        ...
        sx={{
          ...
          minHeight: "56px",
          width: "90%",
          backgroundColor: theme === "dark" ? "#8a517f":"",
          color: theme === "dark" ? "#d9d9d9":""
        }}
      >
        <ListItemIcon
          sx={{
